...
namespace NoCoreWebApi.Controllers
{
    public class ProductsController : ApiController
    {
        ...
        // GET: api/Products
        public async Task<IEnumerable<ProductInfo>> GetProducts(int top, int from)
        {
            ...
            foreach (var product in productList)
            {
                result.Add(new ProductInfo
                {
                    ...
                    Image = await new ProductsImagesController().GetProductsImages(product.ProductId)
                });
            }
