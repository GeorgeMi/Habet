    ...
    Product.prototype.render = function () {
        ...
        if (error) {
            ...
            return (React.createElement("div", null,
                ...
                React.createElement("br", null),
                React.createElement("section", { id: "product", className: "section-bg" },
                    React.createElement("div", { className: "container" },
                        React.createElement("div", { className: "row product-container" },
                            React.createElement("div", { className: "col-lg-4 col-md-6 product-item filter-app wow fadeInUp" },
                                React.createElement("div", { className: "product-wrap" },
                                    React.createElement("figure", null,
                                        ...
                                        React.createElement("a", { href: imageDictionary.Item(item.productId), "data-lightbox": "product", "data-title": item.name, className: "link-preview", title: "Preview" },
