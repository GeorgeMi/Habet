...
export class ResetPassword extends React.Component<any, any> {
    constructor(props) {
        ...
        this.state = { password: '', confirm_password: '', waitingResponse: false, language: read_cookie('lang'), token: props.match.params.id };
...
>                   <div className="hero-wrap page-title" style={{ backgroundImage: "linear-gradient(rgba(255, 255, 255, .5), rgba(255, 255, 255, .8)), url('images/background_2.jpg')" }}>
                        <div className="row justify-content-center">
                            <div className="col-md-12 heading-section text-center">
                                <h1 className="mb-4"><Translate content={'user.ChangePassword'} /></h1>
                            </div>
                        </div>
                    </div>
