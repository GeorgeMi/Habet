                                ...
                                <div className="bg-white p-3" style={{ textAlign: 'justify' }}>
                                    <div className="row justify-content-center mb-3 pb-3">
                                        <div className="col-md-12 heading-section text-center">
                                            <h3 className="mb-4"><Translate content='privacyPolicy.Title' /></h3>
                                        </div>
                                    </div>
...
Drepturile de opunere asupra prelucrării datelor dumneavoastră sunt la fel garantate prin lege, iar solicitarea ștergerii datelor este realizată de către Proprietar, printr-o cerere înregistrată.<br />
                                        În momentul în care unele din datele dumeavoastră sunt incorecte va rugăm să ne anunțați imediat prin orice mijloc de comunicare posibil. </p>
                                            <h5>Politică de confidențialitate GDPR cu privire la prelucrarea datelor cuprinde următoarele informații:</h5>
                                            <h5>1.	Ce reprezintă datele cu caracter general?</h5>
                                        ...
                                        Atunci când vă creați un cont pe site-ul nostru www.gabrielhabet.com, ne transmiteți: adresa de e-mail.<br />
                                            ...
                                            <h5>2.	Ce tipuri de date cu caracter personal colectăm?</h5>
                                            <p>Colectăm urmăroarele date cu caracter personal pentru anumite scopuri și servicii cum ar fi:</p>                                         
                                               -<b>nume și prenume:</b> pentru a putea realiza livrarea produselor comandate, avem nevoie de aceste date;
                                               <br />- <b>e-mail:</b> pentru a realiza o comunicare între platforma și user, adresa de e-mail o folosim pentru a vă confirmă comandă și pentru a vă informa despre stadiul comenzilor;
                                               <br />- <b>număr de telefon:</b> avem nevoie de numărul de telefon pentru confirmarea comenzii și pentru a stabili și alte detalii legate de comandă plasată.
                                               <br />- <b>adresa de livrare:</b> pentru a reuși să livrăm comandă, avem nevoie de comunicarea adresei corecte, în procesul de comandă
                                               <br />- <b>adresa de facturare:</b> pentru a reuși să facem factură fiscală, avem nevoie de comunicare corectă a datelor de facturare 
                                               <br />- <b>prelucrarea comenzilor și soluționarea lor:</b> prelucrarea, validarea, soluționare sau anularea comenzilor și/sau a bunurilor și serviciilor achiziționate. 
                                               <br />- <b>rambursarea banilor:</b> contravaloarea produselor conform prevederilor legalee existente
                                               <br />- <b>rambursarea produselor:</b> returnarea produselor conform prevederilor legale existente 
                                            
                                            <h5>3.	Care este scopul și temeiul prelucrării datelor și cum folosim informațiile tale personale ?</h5>
                                            ...
                                            <h5>4.	Care este temeiul legal prin care colectăm aceste date personale ?</h5>
                                            ...
                                            <h5>5.	Partajarea datelor cu caracter personal.</h5>
                                            ...
                                            <h5>6.	Perioada de retenție a datelor cu caracter personal?</h5>
...
<br />Implicit, nu vor fi accesate în niciun alt scop decât scopul legal pentru care au fost arhivate. După termenul de 10 ani, aceste date vor fi distruse.</p>
                                            <h5>7.	Drepturile persoanei vizate de colectarea datelor personale.</h5>
...
O listare a fiecărui drept îl puteți consulta mai jos:<br />
                                               ...
                                               <br />- rectificare informațiilor sau a datele personale
                                               <br />- ștergerea datelor personale sau a informațiilor. Realizarea acestui drept, aduce cu sine și eliminarea tuturor informațiilor despre user iar gabrielhabet.com nu este vinovat de pierderile suferite de user.
                                               <br />- restricționarea datelor cu caracter personal
                                               <br />- portabilitatea sau opoziția datelor cu caracter personal
                                               <br />- depunerea deplânge la autoritatea de supraveghere
                                            
                                            <h5>8.	Politică de utilizare a cookies-urilor.</h5>
...
Ține minte, de luni până vineri, între orele 09:00 – 17:00 ne poți adresa întrebările tale, iar noi cu plăcere îți vom răspunde.</p>
                                            <h5>Politică de confidențialitate GDPR cu privire la prelucrarea datelor.</h5><p></p>
                                            ...
                                            <div>
                                                <h5><b>Cine suntem și cum putem fi contactați:</b></h5>
                                                <div>
                                                   ...
                                                   <br /> - Pentru orice informații suplimentare despre GDPR sau calitatea de operator în prelucrarea datelor dumneavostră personale, va rugăm să ne contactați peadresa de e-mail: contact@gabrielhabet.com sau telefonic la numărul: +40 753 696 163 
                                                </div>
                                                <h5><b>Ce informații și date cu caracter personal păstrăm și prelucrăm despre dumneavoastră:</b></h5>
                                                <p>Aceste date cu caracter personal, sunt de regulă colectate direct de la utilizator, astfel încât aveți controlul total sau parțial (acolo unde tehnică nu ne permite) asupra tipurilor de informații oferite. </p>
                                            </div>
                                        </div>
                                    }
...
The rights to oppose the processing of your data are also guaranteed by law, and the request for deletion of data is made by the Owner, through a registered request. <br />
                                        If any of your data is incorrect, please notify us immediately by any possible means of communication. </p>
                                            <h5> GDPR's privacy policy regarding data processing includes the following information: </h5>
                                            <h5> 1. What is general data? </h5>
                                        ...
                                        When you create an account on our website www.gabrielhabet.com, send us: e-mail address. <br />
                                            ...
                                            <h5> 2. What types of personal data do we collect? </h5>
                                            <p> We collect the following personal data for certain purposes and services such as: </p>                                        
                                                - <b> first and last name: </b> In order to deliver the ordered products, we need this data; 
                                               <br /> - <b> e-mail: </b> to communicate between the platform and the user, we use the e-mail address to confirm your order and to inform you about the status of orders; 
                                               <br /> - <b> phone number: </b> we need the phone number to confirm the order and to establish other details related to the placed order. 
                                               <br /> - <b> delivery address: </b> in order to deliver the order, we need to communicate the correct address in the order process 
                                               <br /> - <b> billing address: </b> In order to be able to make a tax invoice, we need to communicate the billing information correctly 
                                               <br /> - <b> order processing and settlement: </b> processing, validation, settlement or cancellation of orders and / or purchased goods and services. 
                                               <br /> - <b> money back: </b> the value of the products according to the existing legal provisions 
                                               <br /> - <b> refund of products: </b> return of products according to existing legal provisions 
                                            
                                            <h5> 3. What is the purpose and basis of the data processing and how do we use your personal information? </h5>
                                            ...
                                            <h5> 4. What is the legal basis for which we collect this personal data? </h5>
                                            ...
                                            <h5> 6. Retention period of personal data? </h5>
...
<br /> By default, they will not be accessed for any purpose other than the legal purpose for which they were archived. After 10 years, this data will be destroyed. </p>
                                            <h5> 7. The rights of the data subject to the collection of personal data. </h5>
...
A list of each right can be found below: <br />
                                               ...
                                               <br /> - rectification of information or personal data 
                                               <br /> - deletion of personal data or information. The realization of this right brings with it the elimination of all information about the user and gabrielhabet.com is not guilty of the losses suffered by the user. 
                                               <br /> - restriction of personal data 
                                               <br /> - portability or opposition of personal data 
                                               <br /> - submission complains to the supervisory authority 
                                            ...
                                            <h5> 9. How can you contact us? </h5>
...
Remember, from Monday to Friday, between 09:00 and 17:00 you can ask us your questions, and we will be happy to answer you. </p>
                                            <h5> GDPR privacy policy regarding data processing. </h5> <p> </p>
                                            ...
                                            <div>
                                                <h5> <b> Who we are and how we can be contacted: </b> </h5> 
                                                <div>
                                                   ...
                                                   <br /> - For any additional information about GDPR or the quality of operator in the processing of your personal data, please contact us by e-mail: contact@gabrielhabet.com or by phone at: +40 753 696 163 
                                                </div>
                                                <h5> <b> What personal information and data we store and process about you: </b> </h5> <p> This personal data is usually collected directly from the user, so you have full or partial control (where technology does not allow us) over the types of information provided. </p> 
                                            </div>
                                        </div>
                                    }
...
I diritti di opposizione al trattamento dei tuoi dati sono garantiti anche dalla legge, e la richiesta di cancellazione dei dati è avanzata dal Titolare, tramite richiesta registrata. <br />
                                        Se qualcuno dei tuoi dati non è corretto, ti preghiamo di comunicarcelo immediatamente con ogni possibile mezzo di comunicazione. </p>
                                            <h5> La politica sulla privacy del GDPR relativa al trattamento dei dati include le seguenti informazioni: </h5>
                                            <h5> 1. Cosa sono i dati generali? </h5>
                                        ...
                                        Quando crei un account sul nostro sito web www.gabrielhabet.com, inviaci: indirizzo e-mail. <br />
                                            ...
                                            <h5> 2. Quali tipi di dati personali raccogliamo? </h5>
                                            <p> Raccogliamo i seguenti dati personali per determinati scopi e servizi come: </p>                                           
                                                - <b> nome e cognome: </b> per poter consegnare i prodotti ordinati, abbiamo bisogno di questi dati; 
                                              <br />  - <b> e-mail: </b> per comunicare tra la piattaforma e l'utente, utilizziamo l'indirizzo e-mail per confermare il tuo ordine e per informarti sullo stato degli ordini; 
                                              <br />  - <b> numero di telefono: </b> abbiamo bisogno del numero di telefono per confermare l'ordine e per stabilire altri dettagli relativi all'ordine effettuato. 
                                              <br />  - <b> indirizzo di consegna: </b> al fine di consegnare l'ordine, dobbiamo comunicare l'indirizzo corretto nel processo di ordinazione 
                                              <br />  - <b> indirizzo di fatturazione: </b> per presentare correttamente una fattura fiscale, abbiamo bisogno dei dati di fatturazione corretti 
                                              <br />  - <b> elaborazione e liquidazione degli ordini: </b> elaborazione, convalida, liquidazione o annullamento di ordini e / o beni e servizi acquistati. 
                                              <br />  - <b> rimborso: </b> il valore dei prodotti secondo le disposizioni legali esistenti 
                                              <br />  - <b> rimborso dei prodotti: </b> restituzione dei prodotti in base alle disposizioni legali esistenti 
                                            
                                            <h5> 3. Qual è lo scopo e la base del trattamento dei dati e come utilizziamo le tue informazioni personali? </h5>
                                            ...
                                            <h5> 4. Qual è la base giuridica per la quale raccogliamo questi dati personali? </h5>
                                            ...
                                            <h5> 5. Condivisione dei dati personali. </h5>
                                            ...
                                            <h5> 6. Periodo di conservazione dei dati personali? </h5>
...
<br /> Per impostazione predefinita, non sarà possibile accedervi per scopi diversi dallo scopo legale per il quale sono stati archiviati. Dopo 10 anni, questi dati verranno distrutti. </p>
                                            <h5> 7. I diritti dell'interessato alla raccolta dei dati personali. </h5>
...
Di seguito è riportato un elenco di ciascun diritto: <br />
                                             ...
                                             <br />   - rettifica delle informazioni o dei dati personali 
                                             <br />   - cancellazione di dati o informazioni personali. La realizzazione di questo diritto porta con sé anche l'eliminazione di tutte le informazioni sull'utente e gabrielhabet.com non è colpevole delle perdite subite dall'utente. 
                                             <br />   - limitazione dei dati personali 
                                             <br />   - portabilità o opposizione dei dati personali 
                                             <br />   - presentazione reclami all'autorità di controllo 
                                            
                                            <h5> 8. Politica sui cookie. </h5>
...
Ricorda, dal lunedì al venerdì, dalle 09:00 alle 17:00, puoi farci le tue domande e saremo felici di risponderti. </p>
                                            <h5> Informativa sulla privacy del GDPR relativa al trattamento dei dati. </h5> <p> </p>
                                            ...
                                            <div>
                                                <h5> <b> Chi siamo e come possiamo essere contattati: </b> </h5> 
                                                <div>
                                                   ...
                                                   <br /> - Per qualsiasi informazione aggiuntiva sul GDPR o sulla qualità dell'operatore nel trattamento dei tuoi dati personali, ti preghiamo di contattarci tramite e-mail: contact@gabrielhabet.com o per telefono al: +40 753 696 163 
                                                </div>
                                               <h5> <b> Quali informazioni e dati personali archiviamo ed elaboriamo su di te: </b> </h5> <p> Questi dati personali vengono solitamente raccolti direttamente dall'utente, in modo che tu abbia il controllo totale o parziale (laddove la tecnologia non ci consente) sui tipi di informazioni fornite. </p> 
                                            </div>
                                        </div>
                                    }
                                </div>
